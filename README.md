...
AnnData.jl is a Julia package that provides robust support for working with AnnData, a common data structure used in single-cell bioinformatics. This package is derived from the [Muon.jl](https://github.com/...) library, but specifically focuses on handling AnnData objects, without including functionality for multi-omics data types.
...
The [Muon.jl](https://github.com/...) package is a comprehensive toolkit for multi-omics data analysis, but not all users require multi-omics support. AnnData.jl was created to focus solely on the core AnnData functionality, providing:
